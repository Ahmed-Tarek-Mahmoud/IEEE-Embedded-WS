...
/** @defgroup RCC_CFGR_Bit_Definitions Clock Configuration Register 
 * @{
*/
...
/**
 * @defgroup PLL-INPUT Clock Source Macros
 * @{
 */

#define RCC_PLL_HSI    0   /***< HSI oscillator clock / 2 selected as PLL input clock */
#define RCC_PLL_HSE    1   /***< HSE oscillator clock selected as PLL input clock */

/** @} */ // end of PLL-INPUT

/**
 * @defgroup PLL HSE Divider Macros
 * @{
 */

#define RCC_PLL_DivHSE    0   /***< HSE oscillator clock will be divided by 2 */
#define RCC_PLL_NoDivHSE    1   /***< HSE oscillator clock will not be */

...
*/
  ...
  #define RCC_PLL_INPUT  RCC_PLL_HSE
    ...
    *      RCC_PLL_DivHSE      0      HSE oscillator clock will be divided by 2 
           RCC_PLL_NoDivHSE    1      HSE oscillator clock will not be divided
   */
  #define PLL_HSEDivStatus   RCC_PLL_DivHSE 
     ...
     *   x between 2 and 16
    */
   #define PLL_MulFactor    PLL_MULL2
